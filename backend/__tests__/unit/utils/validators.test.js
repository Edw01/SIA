...
describe('Utilidades de Validación (validators.js)', () => {
    describe('Función: parsePositiveInteger', () => {
        ...
        it('debería lanzar un error si recibe cero o un número negativo', () => {
            expect(() => parsePositiveInteger(0, 'Edad')).toThrow(
                'Edad debe ser un número entero positivo.'
            );
            expect(() => parsePositiveInteger(-5, 'Edad')).toThrow(
                'Edad debe ser un número entero positivo.'
            );
        });

        it('debería lanzar un error si recibe un número decimal', () => {
            expect(() => parsePositiveInteger(5.5, 'Edad')).toThrow(
                'Edad debe ser un número entero positivo.'
            );
            expect(() => parsePositiveInteger('3.14', 'Edad')).toThrow(
                'Edad debe ser un número entero positivo.'
            );
        });

        it('debería lanzar un error si recibe texto u otros tipos inválidos', () => {
            expect(() => parsePositiveInteger('abc', 'Edad')).toThrow(
                'Edad debe ser un número entero positivo.'
            );
            expect(() => parsePositiveInteger(null, 'Edad')).toThrow(
                'Edad debe ser un número entero positivo.'
            );
        });
    });
    ...
    describe('Función: parseNonNegativeInteger', () => {
        ...
        it('debería lanzar un error si recibe un número negativo', () => {
            expect(() => parseNonNegativeInteger(-1, 'Edad')).toThrow(
                'Edad debe ser un número entero no negativo.'
            );
        });

        it('debería lanzar un error si no es un número entero', () => {
            expect(() => parseNonNegativeInteger('abc', 'Edad')).toThrow(
                'Edad debe ser un número entero no negativo.'
            );
            expect(() => parseNonNegativeInteger(1.5, 'Edad')).toThrow(
                'Edad debe ser un número entero no negativo.'
            );
        });
    });
    ...
    describe('Función: validateRequiredString', () => {
        ...
        it('debería lanzar error si no se proporciona un string (null, undefined, number)', () => {
            ...
            expect(() => validateRequiredString(undefined, 'Nombre')).toThrow(
        ...
        it('debería lanzar error si el string excede la longitud máxima permitida', () => {
            ...
            expect(() => validateRequiredString('universidad', 'Nombre', 5)).toThrow(
                'Nombre no puede superar 5 caracteres.'
            );
        });
    });
});
