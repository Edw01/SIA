...
router.post('/inscribir', authenticateToken, authorizeRoles('Estudiante'), InscripcionController.inscribir);
router.delete('/retirar/:inscripcionId', authenticateToken, authorizeRoles('Estudiante'), InscripcionController.retirar);
